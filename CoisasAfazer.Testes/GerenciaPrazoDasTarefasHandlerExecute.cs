...
namespace CoisasAfazer.Testes {
    public class GerenciaPrazoDasTarefasHandlerExecute {
        ...
        [Fact]
        public void QuandoTarefasEstiveremAtrasadasDeveMudarDeStatus() {
            //Fazes
            //Arrange
        ...
        [Fact]
        public void QuandoInvocadoDeveSerChamarAtualizarTarefasNaQtdVezesDoTotalDeTarefasAtrasadas() {
